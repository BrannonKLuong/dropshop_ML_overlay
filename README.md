...
4. Course or build course is designed in one of two forms. Using the User Interface the User draws bounding boxes and returns the same data or for testing purposes a hard-coded version list of arrays. For the sake of explanations, I'll be following a hard-coded version.
